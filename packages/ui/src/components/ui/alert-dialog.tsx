...
function AlertDialogFooter({
  ...
  return (
    <div
      className={cn(
        "-mx-4 mt-2 flex flex-col-reverse gap-2 border-t bg-muted/50 p-4 group-data-[size=sm]/alert-dialog-content:grid group-data-[size=sm]/alert-dialog-content:grid-cols-2 sm:flex-row sm:justify-end",
        className
      )}
