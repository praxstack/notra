...
export function getProfessionalBlogPostPrompt(): string {
  return dedent`
    ...
    Think of posts on the Vercel or Stripe engineering blog: authoritative, technically deep, and focused on developer value.
    </tone-context>
    ...
    Think through what the most interesting themes are from the data. Group related changes. Find the narrative thread. Emphasize technical decisions and trade-offs.
    </thinking-instructions>
  `;
}
