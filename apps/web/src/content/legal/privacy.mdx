...
For analytics, we use [DataBuddy](https://databuddy.cc), a cookie-free, GDPR-compliant analytics service. DataBuddy does not use cookies. For general website analytics, we do not send direct identifiers such as your name or email address. To measure signup conversion and onboarding performance, we may send limited pseudonymous event data such as internal user ID, organization ID, signup method, selected plan, and experiment variant. We do not use DataBuddy for advertising profiles or third-party ad targeting. Because no cookies are used for analytics, no cookie consent banner or opt-out mechanism is required.
...
**Usage Data:** We automatically collect information about how you interact with the Service, including pages visited, features used, timestamps, signup method, onboarding selections, and related product analytics events.
...
- **[DataBuddy](https://databuddy.cc)** — Cookie-free, GDPR-compliant analytics and signup attribution
